...
const staticIssues: Issue[] = [
  {
    ...
    distance: 2.5,
    imageUrl: 'https://images.unsplash.com/photo-1611858445774-99703c13f399?q=80&w=800&auto=format&fit=crop',
  ...
  },
  {
    ...
    distance: 4.2,
    imageUrl: 'https://images.unsplash.com/photo-1632930432935-510a4db5a523?q=80&w=800&auto=format&fit=crop',
  ...
  },
  {
    ...
    distance: 2.0,
    imageUrl: 'https://images.unsplash.com/photo-1589774609758-c46959c9e06f?q=80&w=800&auto=format&fit=crop',
  ...
  },
  {
    ...
    description: 'Someone has spray-painted graffiti on the side of the community hall. It needs to be cleaned up.',
    department: 'Sanitation',
    status: 'Pending',
    location: { lat: 16.518, lng: 80.625 },
    locationAddress: 'Community Hall, Satya Nagar, Vijayawada, 520003',
    distance: 3.5,
    imageUrl: 'https://images.unsplash.com/photo-1595017013938-c6823a4b011f?q=80&w=800&auto=format&fit=crop',
    submittedAt: new Date(new Date().setDate(new Date().getDate() - 1)),
    resolvedAt: null,
    userId: 'USR45678',
    userContact: '9456789012',
    notes: 'The graffiti is offensive.',
    questions: [],
    priority: 'Low',
    resolvedImageUrl: null,
    resolutionNotes: null,
  ...
  {
    id: 'RDT-011',
    title: 'Broken Bench at Riverfront Park',
    description: 'One of the wooden planks on a park bench is broken, making it unsafe to sit on.',
    department: 'Road & Transport',
    status: 'In Progress',
    location: { lat: 16.502, lng: 80.62 },
    locationAddress: 'Riverfront Park, Near Prakasam Barrage, Vijayawada, 520001',
    distance: 4.0,
    imageUrl: 'https://images.unsplash.com/photo-1628593498145-2d5a2b107e15?q=80&w=800&auto=format&fit=crop',
    submittedAt: new Date(new Date().setDate(new Date().getDate() - 7)),
    resolvedAt: null,
    userId: 'USR87654',
    userContact: '9876541230',
    notes: 'This is a popular spot for senior citizens.',
    questions: [],
    priority: 'Medium',
    resolvedImageUrl: null,
    resolutionNotes: null,
  ...
  },
  {
    ...
    description: 'The red light at the intersection of Eluru Road and Besant Road is flickering intermittently. It might cause confusion for drivers.',
    department: 'Electrical',
    status: 'Pending',
    location: { lat: 16.51, lng: 80.635 },
    locationAddress: 'Eluru Rd & Besant Rd Junction, Vijayawada, 520002',
    distance: 2.8,
    imageUrl: 'https://images.unsplash.com/photo-1580536925297-90de4459f134?q=80&w=800&auto=format&fit=crop',
    submittedAt: new Date(new Date().setHours(new Date().getHours() - 12)),
    resolvedAt: null,
    userId: 'USR32109',
    userContact: '9321098765',
    notes: 'Happens mostly in the evenings.',
    questions: ['Is it safe to cross the intersection?'],
    priority: 'High',
    resolvedImageUrl: null,
    resolutionNotes: null,
    resolvedBy: null,
  ...
  {
    id: 'ERR-002',
    title: 'Loud Humming Noise at Night',
    description: 'There\'s a constant loud humming noise coming from somewhere near my house every night. I think it\'s from a transformer box.',
    department: 'Electrical',
    status: 'Error',
    location: { lat: 16.498, lng: 80.648 },
    locationAddress: 'Subash Nagar, Vijayawada, 520007',
    distance: 1.5,
    imageUrl: 'https://images.unsplash.com/photo-1619177380230-78c5b1b0a71b?q=80&w=800&auto=format&fit=crop',
    submittedAt: new Date(new Date().setDate(new Date().getDate() - 9)),
    resolvedAt: null,
    userId: 'USR55555',
    userContact: '9555555555',
    notes: 'Investigation found the source to be a private air conditioning unit. Not a municipal responsibility. Marked as error.',
    questions: [],
    priority: 'Low',
    resolvedImageUrl: null,
    resolutionNotes: null,
